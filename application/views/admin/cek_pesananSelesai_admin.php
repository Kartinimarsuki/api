                                ...
                                <div class="col-lg-8">
                                    <div class="p-5">
                                        ...
                                        <div class="row d-flex justify-content-between align-items-center">
                                            ...
                                            <p><?= $pesananSelesai[0]['id_transaksi'] ?></p>
                                        </div>
                                        <div class="row d-flex justify-content-between align-items-center">
                                            <label>Nama Customer:</label>
                                            <p><?= $pesananSelesai[0]['nama'] ?></p>
                                        </div>
                                        <div class="row d-flex justify-content-between align-items-center">
                                            <label>Pesanan:</label>
                                            <?php
                                            foreach ($pesananSelesaiDetail as $row) {
                                                echo '<span>' . $row['id_transaksi_detail'] . '. ' . $row['nama_produk'] . ' (' . $row['jumlah_barang'] . ' Produk)</span>';
                                            }
                                            ?>
                                        </div>
                                        <div class="pt-5">
                                            <h6 class="mb-0"><a href="<?= base_url('Done_order_admin') ?>" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Kembali</a></h6>
                                        </div>
                                    </div>
                                </div>
